        ...
        <div className="h-screen">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center text-white">
                    <h1 className="mb-4 text-7xl tracking-tight font-extrabold lg:text-7xl">Something went wrong</h1>
                    <p className="mb-4 text-3xl tracking-tight font-bold md:text-4xl">Our server encountered an error. Please try again in a moment.</p>
